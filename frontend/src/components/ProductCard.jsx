...
export default function ProductCard({ product }) {
  ...
  return (
    <motion.div variants={cardVar} whileHover="hover" className='card p-4 group relative'>
      <div className='relative overflow-hidden rounded-xl'>
        ...
        <button
          ...
          className='absolute top-3 right-3 bg-black/40 backdrop-blur-md p-2 rounded-full hover:bg-brand-green hover:text-white transition-colors'
        >
